...
public class IndianRailwayTicket { //name of the table is same as the class
	...
	public String toString() {
		return "IndianRailwayTicket [ticketId=" + ticketId + ", passengerName=" + passengerName + ", age=" + age
				+ ", sourceCity=" + sourceCity + ", destinationCity=" + destinationCity + ", ticketCost=" + ticketCost
				+ "]";
	}
